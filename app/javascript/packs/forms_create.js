$(document).ready(function(){
    ...
    $("#add_question_btn").click(function(){
        ...
        $("#sortable").append(`
            <div id="form_question_${question_counter}_div" class="mb-3 p-4 border border-success rounded">
                <div class="row">
                    <div class="col-lg-9">
    ...
    $(document).on("click", ".add_choice", function(){
        ...
        if($(`#form_question_${$(this).data("add-choice-id")}_choice_div`).length > 0){
            $(`#form_question_${$(this).data("add-choice-id")}_choice_div`).after(`
                <div id="form_question_${$(this).data("add-choice-id")}_choice_div" class="input-group mb-3">
    ...
    $(document).on("change", ".form_question_type", function(){
        ...
        $(this).data("question-type-id", question_counter);
    });
});